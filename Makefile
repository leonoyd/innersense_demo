...
#LD_FLAGS := -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -std=gnu11 -DUSE_HAL_DRIVER -DSTM32F303xE -DUSE_STM32F3XX_NUCLEO -Os -ffunction-sections -g3 -fstack-usage -Wall -fmessage-length=0 -specs=nano.specs
...
LD_FLAGS := -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -std=gnu11 -DUSE_HAL_DRIVER -DSTM32F303xE -DUSE_STM32F3XX_NUCLEO -Os -ffunction-sections -g3 -fstack-usage -Wall -fmessage-length=0 -Wno-unused-variable -Wno-pointer-sign -Wno-main -Wno-format -Wno-address -Wno-unused-but-set-variable -Wno-strict-aliasing -Wno-parentheses -Wno-missing-braces -specs=nano.specs -o Drivers/STM32F3xx_HAL_Driver/stm32f3xx_hal_cortex.o
LDS_FLAG := -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -TSW4STM32/STM32F303RE-Nucleo/STM32F303RETx_FLASH.ld -specs=nosys.specs -static -Wl,-Map=STM32F303RE-Nucleo.map -Wl,--gc-sections -Wl,--defsym=malloc_getpagesize_P=0x80 -Wl,--start-group -lc -lm -Wl,--end-group -specs=nano.specs
